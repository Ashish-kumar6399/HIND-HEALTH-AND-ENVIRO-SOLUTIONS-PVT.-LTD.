...
//         img:'/image/Receiver  Interface Unit (3).webp',
...
const Data = [
  ...
  {
    id: 2,
    name: "Six Seated Mobile Toilet on Two Wheels",
    Description:"A six-seated mobile toilet on two wheels is a portable sanitation unit designed for outdoor events, construction sites, and remote areas. Built on a sturdy two-wheel trailer, it is easy to tow and set up in various locations. The unit provides six individual toilet cubicles, offering privacy and convenience for multiple users at once.",
    img: "/image/img/six seater back with Emboss.png",
    features1: "Portability: Mounted on two wheels, it’s easy to tow and transport to different locations.",
    features2: "Multi-User Capacity: Equipped with six individual cubicles, allowing multiple people to use it simultaneously.",
    feature3: "Privacy and Comfort: Each cubicle offers privacy, with secure doors and essential amenities for a comfortable user experience.",
     Wheel : "No of wheel- 2",
  ...
  {
    id: 3,
    name: "Six Seated Classic Mobile Toilet Trolley",
    Description:"Six Seated Classic Mobile Toilet Trolley. It is designed having a fiber sheet made shed, beautiful toilet cabin doors, strong stairs, a piping assembly to assure proper drainage & water supply, and three wheels to allow it to move. This mobile toilet trolley can be easily transported to desired places with the help of a commercial vehicle. We offer Six Seated Classic Mobile Toilet Trolley at highly competitive prices and in customizable specifications as demanded by our clients.",
    img: "/image/img/Six Seated Classic Mobile Toilet Trolley.webp",
    features1: "Completely suitable to be used in rainy season",
    features2: "6 persons can use it simultaneously",
    feature3: "Proper lighting and ventilation is assured",
     Wheel : "No of wheel- 3",
     Compartment:"No of Comapartment- 6",
     Tank:"  Tank Capacity- 500L",
     Brand:"Brand- HHES",
  ...
  },
  {
    id: 4,
    name: "Mobile Toilet",
    Description:"A mobile toilet is a portable restroom unit designed for temporary use in outdoor locations. It provides essential sanitation facilities, is easy to transport, and offers a hygienic solution for areas without permanent restrooms.",
    img: "/image/img/Mobile Toilet.png",
    features1: "Portability: Designed for easy transport to various locations, often mounted on wheels for convenience.",
    features2: "Self-Contained System: Equipped with a waste tank, hand sanitizer or sink, and ventilation, making it independent of external plumbing.",
    feature3: "Hygienic Design: Includes dispensers for tissue and sanitizers, with ventilation to reduce odors and enhance cleanliness.",
     Wheel : "No of wheel- 3",
     Compartment:"No of Comapartment- 6",
     Tank:"  Tank Capacity- 500L",
     Brand:"Brand- HHES",
  ...
  {
    id: 5,
    name: "Portable Four Seater Mobile Toilet",
    Description:"This Portable Four Seater Mobile Toilet Van is manufactured with the implication of pioneering tools and techniques by a team of adroit professionals. It is demanded at construction sites and restaurants to provide temporary toilet utilities. Also, our offered van is extensively used during outdoor functions and events from a remote distance of homes, hotels and other accommodation places. Extensively demanded in tourist places, this van is designed with sanitary and proper lighting fittings. Along with this, the provided van can be customized as per specifications laid down by customers.",
    img: "/image/img/Portable Four Seater Mobile Toilet.jpeg",
    features1: "Known to withstand harsh weather condition",
    features2: "Easy mobility and maintenance",
    feature3: "Fitted with water tap and tank",
     Wheel : "No of wheel- 2",
  ...
  {
    id: 6,
    name: "Modular Mobile Toilet",
    Description:"A modular mobile toilet is a portable restroom unit designed with customizable sections, allowing for easy expansion or reconfiguration. Ideal for outdoor events, construction sites, and emergency setups, it combines flexibility with essential sanitation features, offering a durable and hygienic solution for temporary restroom needs.",
    img: "/image/img/Modular 10 seater  Mobile Toilet.webp",
    features1: "Known to withstand harsh weather condition",
    features2: "Easy mobility and maintenance",
    feature3: "Fitted with water tap and tank",
     Wheel : "No of wheel- 4",
  ...
  {
    id: 7,
    name: "Two Seater Mobile Toilet",
    Description:"A two-seater mobile toilet is a compact, portable restroom unit with two separate cubicles, designed for use in outdoor or temporary settings. It provides essential sanitation facilities with easy mobility, making it ideal for small events, construction sites, and remote locations.",
    img: "/image/img/Two Seater Mobile Toilet.webp",
    features1: "Dual Cubicles: Offers two separate, private restroom spaces, allowing for simultaneous use by multiple people.",
    features2: "Portability: Mounted on wheels for easy transport and positioning at various locations.",
    feature3: "Ventilation: Designed with vents to reduce odors and maintain airflow.",
     Wheel : "No of wheel- 2",
     Compartment:"No of Comapartment- 2",
     Tank:"  Tank Capacity- 500L",
     Brand:"Brand- HHES",
  ...
  {
    id: 9,
    name: "Six Seater Mobile Toilet Trolley",
    ...
    img: "/image/img/Six Seater Mobile Toilet Trolley.webp",
  ...
  {
    id: 10,
    name: "Economical Mobile Toilet",
    Description:"Economical Mobile Toilet Van has been specially designed to suit hygiene requirements of common people. This mobile toilet is equipped with total ten cabin. Made of FRP material, this mobile toilet van can be handled easily. Economical Mobile Toilet Van offered by us have modern amenities like solar powered lighting arrangement, water supplying facility and drainage network. Offered movable type toilet van is equipped with four heavy duty tires for its trouble free relocation especially in areas where conventionally built toilet facility is not available.",
    img: "/image/img/Economical Mobile Toilet.png",
    features1: "modern amenities like solar powered lighting arrangement, water supplying facility and drainage network",
    features2: "This mobile toilet is equipped with total ten cabin.",
    feature3: "toilet van is equipped with four heavy duty tires",
     Wheel : "No of wheel- 4",
     Compartment:"No of Comapartment- 10",
     Tank:"  Tank Capacity- 500L",
     Brand:"Brand- HHES",
